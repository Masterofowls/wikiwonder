...
urlpatterns = [
    ...
    path("wiki/api/bulk-import-wikipedia/", views_upload.WikipediaBulkImportView.as_view(), name="bulk_import_wikipedia"),
    path("wiki/api/categories/quick/", views_taxonomy.QuickCategoryCreateView.as_view(), name="quick_category"),
    path("wiki/api/tags/suggest/", views_taxonomy.TagSuggestView.as_view(), name="tag_suggest"),
    path("wiki/api/local-page/", views.LocalWikiPageAPIView.as_view(), name="local_wiki_page"),
    ...
    path("wiki/<slug:slug>/link-audit/", views.PageLinkAuditView.as_view(), name="page_link_audit"),
